...
This repo supports a talk proposal:

**Building a Private-by-Design Agentic AI Platform for Kubernetes Incident Triage**

The talk is about the platform pattern, not a product pitch:

- multi-cluster MCP federation
- Kagent as a Kubernetes-native agent runtime
- Agentgateway as a governed MCP routing layer
- ChatOps for incident workflows
- guardrails and approval boundaries
- private/self-hosted LLM options for organizations that cannot send operational data outside their boundary

See [docs/talk-abstract.md](docs/talk-abstract.md) for CFP-ready wording.
...
- real authentication between components
- network policies
- audit logging
...
- incident data retention controls
